...
equation~\refp{eq:eta_rgal}~\citep[see][]{Weinberg2017}, and in the inside-out 
...
$\eta(\rgal)$ prescription in equation~\refp{eq:eta_rgal}. 
...
% effect not present in~\hsim~(see discussion in~\S~\ref{sec:methods:h277}). 
}
...
sequence. 
% \citet{Weinberg2017} and~\citet{Johnson2020} proposed that
